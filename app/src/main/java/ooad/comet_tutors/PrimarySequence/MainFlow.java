...
public class MainFlow extends Activity
        implements NavigationDrawerFragment.NavigationDrawerCallbacks, ProfileFragment.OnFragmentInteractionListener, TutorFragment.OnFragmentInteractionListener {
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position)
        {
            ...
            case 1:
                fragmentManager.beginTransaction()
                        .replace(R.id.container, new TutorFragment())
                        .commit();
                break;
            case 2:
                break;
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            case 1:
                ...
                break;
            case 2:
                mTitle = getString(R.string.title_section2op1);
                break;
            case 3:
